      ...
      contents: [
        TargetContent(
          ...
          builder: (context, controller) => TourStepContent(
            ...
            body: 'Tocá el listón para marcarlo como favorito y encontrarlo '
      ...
      contents: [
        TargetContent(
          ...
          builder: (context, controller) => TourStepContent(
            ...
            body: 'Después de elegir las opciones, generá un código QR '
                'para que los presentes puedan acceder a las respuestas '
                'y participar de la celebración desde sus teléfonos.',
            onNext: controller.next,
          ),
        ),
      ],
